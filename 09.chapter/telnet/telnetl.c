    ...
    {  
        ...
        {  
            ...
            {  
                close(sockfd); 
                // it works !!
                execl("/sbin/mingetty", "mingetty", slave_name, NULL);  
                //execl("/sbin/agetty", "agetty", "9600", slave_name, NULL);  
                //printf ("login: \n"); 
                //char username[1024] = { 0 }; 
                //fgets (username, sizeof(username), stdin); 
                //printf ("get login name: %s\n", username); 
                //
                //char buf[1024] = { 0 }; 
                //sprintf (buf, "TERM=%s", slave_name); 
                //char *envp[] = 
                //{
                //    buf, 
                //    NULL
                //}; 
                //execle("/bin/login", "login", "-p",  NULL, envp);  
            }  
            else  
            {  
