#! /bin/awk -f
BEGIN {
#printf("#define __USE_POSIX \n")
#printf("#define __USE_POSIX2 \n")
#printf("#define __USE_XOPEN  \n")
...
printf("\n")
printf("#ifdef _%s\n", $1)
printf("  printf (\"_%s defined to be %%d\\n\", _%s); \n", $1, $1)
printf("#else \n")
printf("  printf (\"no symbol for _%s\\n\"); \n", $1)
printf("#endif \n")
printf("\n")
...
printf("\n")
printf("#ifdef P%s\n", $1)
printf("  printf (\"P%s defined to be %%d\\n\", P%s); \n", $1, $1)
printf("#else \n")
printf("  printf (\"no symbol for P%s\\n\"); \n", $1)
printf("#endif \n")
printf("\n")
printf("#ifdef _SC_%s\n", $1)
